...
export const MdEditor:React.FC<EditorProps>=({content, onChange})=>{
  return (
    <div className='grid grid-cols-2 h-full w-full overflow-hidden'>
      <div className='bg-neutral-900/30 flex flex-col overflow-hidden h-full'>
      ...
      <div className='bg-neutral-900/30 flex flex-col overflow-hidden h-full border-l border-neutral-800'>
        ...
        <div className='flex-1 p-4 oveflow-y-auto prose prose-invert max-w-none font-inter overflow-hidden'>
          {/* old code very simple */}
          {/* <ReactMarkdown>{content || "*preview txtt...*"}</ReactMarkdown> */} 

          <div className='flex-1 overflow-y-auto prose prose-invert prose-neutral max-w-none h-full prose-headings:border-b
            prose-headings:pb-2 
            prose-headings:font-semibold
            prose-headings:border-neutral-600
            prose-h1:text-3xl
            prose-h2:text-2xl
            prose-h3:text-xl
            prose-h4:text-lg
