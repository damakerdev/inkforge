    ...
    const handleExportAllJSON = () => {
      ...
      return (
        <div className="fixed inset-0 z-50 bg-neutral-950/80 backdrop-blur-sm flex items-center justify-center p-4">
            <div className="bg-neutral-900 border border-neutral-800 rounded-lg w-full max-w-md flex flex-col shadow-2xl overflow-hidden">
                {/* Header */}
                            ...
                            <div className="p-2.5 rounded-md bg-sky-950 border border-sky-800/60 text-sky-400 group-hover:scale-105 transition-transform">
                             ...
                             <div>
                                ...
                                <div className = "text-xs text-neutral-500 font-mono">
                                    {activeNote ? `${activeNote.title || 'Untitled'}.md` : 'No active note selected'}
                                    </div>
                                </div>
                        </button>
                        <button
                            ...
                            >
                                <div className = "p-2.5 rounded-md bg-emerald-950 border border-emerald-800/60 text-emerald-400 group-hover:scale-105 transition-transform">
                                    ...
                                    <div className="text-xs text-neutral-500 font-mono">
                                        Export all {notes.length} notes as a JSON file
                                    </div>
                                </div>
                            </button>
                        </div>
